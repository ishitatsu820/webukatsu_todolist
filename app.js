...
$(document).on('click', '.js-click-done', function(){
  $(this).addClass('fa-check-square').removeClass('fa-square').removeClass('js-click-done').addClass('js-click-todo').closest('.js-todo_list-item').addClass('list__item--done');
});
...
$(document).on('click', '.js-click-todo', function(){
  ...
  .addClass('js-click-done').removeClass('js-click-todo').closest('.js-todo_list-item').removeClass('list__item--done');
});
